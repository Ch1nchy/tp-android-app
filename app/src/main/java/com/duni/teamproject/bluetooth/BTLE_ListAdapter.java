...
public class BTLE_ListAdapter extends ArrayAdapter<BTLE_Device> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (name != null && name.length() > 0) {
            ...
            tv_name.setText("No name"); // There is a string for this, it just isnt working
        }
        ...
        if (address != null && address.length() > 0) {
            tv_macaddress.setText(device.getAddress());
        } else {
            tv_macaddress.setText("No Mac Address"); // Also is a string here...
        }
